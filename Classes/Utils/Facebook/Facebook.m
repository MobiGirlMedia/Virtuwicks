...
static NSString* kUIserverBaseURL = @"https://www.facebook.com/connect/uiserver.php";
...
- (id) init {
	...
	currentSession = [[NSMutableDictionary alloc] init];
	
	return self;
}

- (void) setCurrentSession:(NSMutableDictionary *) d {
	[currentSession addEntriesFromDictionary: d];
}
